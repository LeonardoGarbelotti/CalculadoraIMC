...
public class Tela extends javax.swing.JFrame {
    ...
    private void jCalculaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCalculaActionPerformed
        ...
        weight.setPeso(jPeso.getText());
        //weight.setPeso(71); //passando pelo metodo peso sobrecarregado
        height.setAltura(jAltura.getText());
        //height.setAltura("1.70");//passando pelo metodo altura sobrecarregado
        a.setImc(weight.getPeso(), height.getAltura());
        if(a.getImc()<=18.5){
            jIMC.setText(String.valueOf(a.getImc())+ " -Abaixo do peso");
        }else if(a.getImc()>18.5 && a.getImc()<=24.9){
            jIMC.setText(String.valueOf(a.getImc()) + " -Peso normal");
        }else if(a.getImc()>24.8 && a.getImc()<=29.9){
            jIMC.setText(String.valueOf(a.getImc()) + " -Sobrepeso");
        }else if(a.getImc()>29.9 && a.getImc()<=34.9){
            jIMC.setText(String.valueOf(a.getImc()) + " -Obesidade");
        }else if(a.getImc()>34.9 && a.getImc()<=39.9){
            jIMC.setText(String.valueOf(a.getImc()) + " -Obesidade moderada");
        }else if(a.getImc()>39.9 && a.getImc()<=49.9){
            jIMC.setText(String.valueOf(a.getImc()) + " -Obesidade severa");
        }else if(a.getImc()>49.9){
            jIMC.setText(String.valueOf(a.getImc()) + " -Obesidade morbida");
        }
